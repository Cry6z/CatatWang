...
@section('title', 'Pemasukan - CatatWang')
@section('page-title', 'Pemasukan')
@section('page-description', 'Kelola data pemasukan kelas')
...
<div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center">
                <div class="w-12 h-12 bg-green-100 dark:bg-green-900/20 rounded-lg flex items-center justify-center">
                    <i class="fas fa-calendar-month text-green-600 dark:text-green-400 text-xl"></i>
                </div>
                <div class="ml-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center">
                <div class="w-12 h-12 bg-blue-100 dark:bg-blue-900/20 rounded-lg flex items-center justify-center">
                    <i class="fas fa-calendar-year text-blue-600 dark:text-blue-400 text-xl"></i>
                </div>
                <div class="ml-4">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="md:col-span-4 flex space-x-3">
                ...
                <a href="{{ route('transactions.income') }}" class="px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white rounded-lg transition-colors">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Data Pemasukan</h3>
        </div>
        ...
        <div class="text-center py-12">
            ...
            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">Belum ada data pemasukan</h3>
            <p class="text-gray-500 dark:text-gray-400 mb-6">Mulai catat pemasukan kelas Anda</p>
            @can('manage-transactions')
            <a href="{{ route('transactions.create', ['type' => 'income']) }}" 
               class="inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-lg transition-colors">
                <i class="fas fa-plus mr-2"></i>
